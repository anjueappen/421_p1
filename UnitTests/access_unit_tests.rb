...
class AccessUnitTests < Test::Unit::TestCase
  ...
  def test_row_count
    ...
    #pre        
    assert_not_nil sparse_matrix.val_row, "SparseMatrix val_row stored should not be nil"
  ...
  def test_first_minor
    ...
    #data tests
    assert_equal Matrix[[1,0],[1,0]], sparse_matrix.first_minor(i,j), "first_minor() function failed."
